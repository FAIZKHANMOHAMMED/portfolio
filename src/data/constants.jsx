...
export const Bio = {
  ...
  github: "https://github.com/FAIZKHANMOHAMMED",
  resume:
    "https://drive.usercontent.google.com/download?id=1storNG1n_KnqKV6MWRlXmOrJcL_fRevj",
  linkedin: "https://www.linkedin.com/in/faizkhanmohammed8074/",
  twitter: "#",
  insta: "#/",
  facebook: "#/",
};
...
export const skills = [
  {
    ...
    skills: [
      ...
      },
      {
        name: "Tailwind",
        image:
          "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/JavaScript-logo.png/800px-JavaScript-lo.png",
      },
      {
        name: "Bootstrap",
        image:
...
export const experiences = [
  {
    ...
    desc: "Designed and developed responsive web applications using modern JavaScript frameworks. Collaborated in an Agile development environment, participating in daily stand-ups and sprint planning. Implemented RESTful APIs and integrated third-party services.",
    skills: [
      "HTML5",
"CSS3",
"JavaScript",
